...
from two_simplicial.ops.tlx.fwd_ws import two_simplicial_tlx_fwd_ws as tlx_fwd_ws
from two_simplicial.ops.tlx.fwd_ws_pingpong import (
    two_simplicial_tlx_fwd_ws as tlx_fwd_ws_pingpong,
)
from two_simplicial.ops.triton.fwd import two_simplicial_fwd as triton_fwd
...
@triton.testing.perf_report(
    [
        ...
        triton.testing.Benchmark(
            ...
            ylabel="Latency (ms)",
            plot_name=f"two_simplicial-benchmark-{B=}-{Hk=}-{D=}-{W1=}-tflops",
            args={
                "B": B,  # batch
                "Hk": Hk,  # kv_heads
                "D": D,  # head_dim
...
def _benchmark(B, N, w2, Hq, Hk, D, w1, provider):
    ...
    total_tflops = (
        get_two_simplicial_tensor_core_tflops(B, N, Hq, Hk, D, w1, w2)
