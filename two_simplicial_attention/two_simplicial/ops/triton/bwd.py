...
@triton.jit
def two_simplicial_bwd_kv1_kernel(
    Q_ptr,  # [b, s, k, h]
    K1_ptr,  # [b, s, k, h]
    K2_ptr,  # [b, s, k, h]
    V1_ptr,  # [b, s, k, h]
...
def two_simplicial_bwd_kv1_triton(
    q,
    k1,
    k2,
    v1,
    ...
    two_simplicial_bwd_kv1_kernel[grid](
        q,
        k1,
        k2,
        v1,
...
@triton.jit
def two_simplicial_bwd_kv2q_kernel(
    Q_ptr,  # [b, s, k, h]
    K1_ptr,  # [b, s, k, h]
    K2_ptr,  # [b, s, k, h]
    V1_ptr,  # [b, s, k, h]
...
def two_simplicial_bwd_kv2q_triton(
    q,
    k1,
    k2,
    v1,
    ...
    for is_second_pass in [False, True]:
        two_simplicial_bwd_kv2q_kernel[grid](
            q,
            k1,
            k2,
            v1,
...
@triton.jit
def two_simplicial_bwd_pre_kernel(
    O_ptr,  # [b, s, k, h]
    dO_ptr,  # [b, s, k, h]
    d_ptr,  # [b, k, s]
    bs,
...
def two_simplicial_bwd_pre_triton(o, dO):
    ...
    # d = sum(o * dO, dim=-1)
    two_simplicial_bwd_pre_kernel[grid](
        o,
        dO,
        d,
        bs,
...
def two_simplicial_bwd(q, k1, k2, v1, v2, o, dO, m, w1, w2, k2_bias=None, v2_bias=None):
    ...
    d = two_simplicial_bwd_pre_triton(o, dO)

    two_simplicial_bwd_kv1_triton(
        q, k1, k2, v1, v2, dO, m, d, w1, w2, dk1, dv1, None, sm_scale=sm_scale
    )

    assert w2 == 32
    two_simplicial_bwd_kv2q_triton(
