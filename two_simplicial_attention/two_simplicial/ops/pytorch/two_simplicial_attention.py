...
from two_simplicial.ops.triton.bwd import two_simplicial_bwd
...
class TwoSimplicialAttention(torch.nn.Module):
    ...
    def forward(
        ...
        output = TwoSimplicialAttentionFunction.apply(
            xq,
            xk1,
            xk2,
            xv1,
...
class TwoSimplicialAttentionFunction(torch.autograd.Function):
    ...
    def forward(
        ...
        output, max_plus_lse = two_simplicial_fwd(xq, xk1, xk2, xv1, xv2, w1, w2)
        ctx.w1 = w1
        ctx.w2 = w2
    ...
    def backward(
        ...
        dq, dk1, dk2, dv1, dv2 = two_simplicial_bwd(
            q,
            k1,
            k2,
            v1,
...
# ======================= Forward passes. =======================
def two_simplicial_attn_fwd_ref(
    q,
    k1,
    k2,
    v1,
    ...
    """Reference impl for two_simplicial attention.
...
# ======================= Backward passes. =======================
def two_simplicial_attn_bwd_ref(
