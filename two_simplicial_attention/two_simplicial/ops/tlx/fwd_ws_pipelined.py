...
@triton.jit
def _two_simplicial_tlx_fwd_ws_kernel_pipelined(
    desc_q,  # [b, s, k, h]
    desc_k1,  # [b, s, 1, h]
    desc_k2,  # [b, s, 1, h]
    desc_v1,  # [b, s, 1, h]
...
def two_simplicial_tlx_fwd_ws(
    ...
    _two_simplicial_tlx_fwd_ws_kernel_pipelined[grid](
        desc_q,
        desc_k1,
        desc_k2,
        desc_v1,
...
def _bench():
    ...
    for w2 in w2s:
        for seq_len in seq_lens:
            ...
            print(
                f"{bs=} {seq_len=} {num_heads=} {head_dim=} {w1=} {w2=} | latency ms={ms:.3f} two_simplicial_tflops={two_simplicial_tflops:.3f} tensor_core_tflops={tensor_core_tflops:.3f}"
            )
