...
# Add the parent directory to the path to import triplet.utils
...
def quick_calculate(block_m=64, block_kv=128, n=8192, w1=32, w2=512, d=128):
    ...
    total_valid_tflops = get_triplet_tensor_core_tflops(1, n, hq, 1, d, w1, w2)
...
"""
python3 triplet_swa_wasted_tflops_analysis.py


Triplet Attention with 2D Sliding Window Wasted TFLOPs Analysis:
------------------------------
...
if __name__ == "__main__":
    print("Triplet Attention with 2D Sliding Window Wasted TFLOPs Analysis:")
