...
# Triplet attention variant reference implementations.
...
def triplet_attn_fwd_ref(
    ...
    """Reference impl for triplet attention.
    ...
    if variant == "strassen":
        ...
        )  # note this is a matmul, not kronecker like in normal triplet.
